...
class BlueROVController:
    ...
    async def run_controller_async(self, num_steps, fwsec, runtime):
    ...
    def run_controller(self, num_steps, fwsec, runtime):
        asyncio.run(self.run_controller_async(num_steps, fwsec, runtime))
...
if __name__ == "__main__":
    ...
    parser.add_argument("--fwsec",type=float,default=2.0,help="Time duration to apply forward force.")
