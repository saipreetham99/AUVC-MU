...
# ============================================================================
# NETWORK AND DATA CLASSES (CORRECT versions from file 1)
# ============================================================================
...
# ============================================================================
# GUI VISUALIZER CLASS (CORRECT version from file 1)
# ============================================================================
...
class CombinedVisualizer: # CORRECT
    ...
    def update(self, imu_override: Optional[np.ndarray] = None):
        ...
        if imu_data is None and imu_override is not None:
            ...
            roll, pitch, yaw = np.degrees(r), np.degrees(p), np.degrees(y_angle)
            imu_data = {'quaternion': imu_override, 'euler_deg': {'roll': roll, 'pitch': pitch, 'yaw': yaw}}
        ...
        if imu_data and 'quaternion' in imu_data and not np.any(np.isnan(imu_data['quaternion'])):
            ...
            new_faces = [[rotated_verts[i] for i in face] for face in self.pyramid_faces_indices]
...
# ============================================================================
# ADVANCED AUV (SIMULATOR) DRIVER (CORRECT version from file 2)
# ============================================================================
...
# ============================================================================
# REAL SUBMARINE CLIENT (CORRECT version from file 2)
# ============================================================================
...
# ============================================================================
# CONTROLLER (CORRECT version from file 2)
# ============================================================================
